                    ...
                    <div className="text-container">
                        ...
                        <button className="btn-solid-reg popup-with-move-anim" onClick={(e) => this.setState({isOpen:true})} >REGISTER</button>
	  					<Dialog isOpen={this.state.isOpen} onClose={(e) => this.setState({isOpen:false})}>
	  						<iframe title="speakerform" src="https://docs.google.com/forms/d/e/1FAIpQLScN9yEX4Z_hIBweZrF1ju_83_oc9QFwC8UCR_B_FtUHBr8dhg/viewform?usp=sf_link" width="640" height="500" frameBorder="0" marginheight="0" marginwidth="0">Loading…</iframe>
						</Dialog>
                    </div> 
                </div> 
            </div> 
